...
const ChatList = () => {
  ...
  useEffect(() => {
    const fetchAllChatHistories = async () => {
      try {
        const response = await fetch("https://chatbot-with-openai-33ug.onrender.com/allChatHistory");
  ...
  const sendMessageToBot = async (message) => {
    try {
      const response = await fetch("https://chatbot-with-openai-33ug.onrender.com/sendMessagebot", {
        method: "POST",
        headers: {
  ...
  const handleSendMessageBotend = async () => {
    try {
      await fetch("https://chatbot-with-openai-33ug.onrender.com/sendMessagebotend", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleSendMessageBotstart = async () => {
    try {
      await fetch("https://chatbot-with-openai-33ug.onrender.com/sendMessagebotstart", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const callNewAPI = async () => {
    try {
      const response = await fetch("https://chatbot-with-openai-33ug.onrender.com/viewUserData");
      const data = await response.json();
      setUserData(data);
    } catch (error) {
