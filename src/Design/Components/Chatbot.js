  ...
  const fetchChatHistory = async (chatId) => {
    try {
      const response = await axios.get(
        `https://chatbot-with-openai-33ug.onrender.com/chatHistory/${chatId}`
        // `https://chatbot-with-openai-33ug.onrender.com/chatHistory/${chatId}`
      );
      ...
      if (controlActive) {
        try {
          const response = await axios.post(
            "https://chatbot-with-openai-33ug.onrender.com/sendMessage",
            {
              chatId: chatId,
              message: input,
            }
        ...
        try {
          const response = await axios.post(
            "https://chatbot-with-openai-33ug.onrender.com/sendMessageuser",
            {
              chatId: chatId,
              message: input,
            }
